...
-export([get_records_from_phone_book/0, search_by_id/2,
    search_by_name/2, search_by_phone/2, search/3]).


% This function get records from phonebook-file
% note: Usage example: Database = get_records_from_phone_book().
%     Function will ask you to write filepath to db.
get_records_from_phone_book() ->
    {ok, Filename} = io:fread("File path: ", "~s"),
